...
TAG_TERMS = {
    ...
    "action": {
        ...
        "搬运货物": ("搬运货物", "搬运", "搬货", "carry cargo", "moving cargo"),
        "装卸货物": ("装卸货物", "装货", "卸货", "load cargo", "unload cargo"),
        "处理包裹": ("处理包裹", "整理包裹", "parcel handling"),
        "打包": ("打包", "包装", "packing", "packaging"),
    ...
    "scene": {
        ...
        "货物存储": ("货物存储", "货架存储", "货物存放", "cargo storage"),
        "货架通道": ("货架通道", "货架区", "aisle", "rack aisle"),
        "货物分拣": ("货物分拣", "分拣区", "cargo sorting"),
        "装卸货区": ("装卸货区", "装卸货", "loading bay", "dock"),
...
MODEL_TAG_ALIASES = {
    "scene": {
        ...
        "cargo storage": "货物存储", "storage area": "货物存储",
        "aisle": "货架通道", "rack aisle": "货架通道",
        "sorting area": "货物分拣", "loading bay": "装卸货区", "loading dock": "装卸货区",
    },
    "object": {
        "truck": "卡车", "lorry": "卡车", "trailer": "拖车", "van": "货车",
        "container": "集装箱", "crane": "吊机", "gantry": "吊机",
        "ship": "船舶", "vessel": "船舶",
        "box": "纸箱", "carton": "纸箱", "cardboard box": "纸箱",
        "parcel": "包裹", "package": "包裹", "cargo": "货物", "goods": "货物",
        "pallet": "托盘", "tote": "周转箱", "bin": "周转箱",
    },
    "action": {
        "stacking": "堆放", "stacked": "堆放", "loading": "装卸", "unloading": "装卸",
        "packing": "打包", "packaging": "打包",
        "moving cargo": "搬运货物", "carrying boxes": "搬运货物",
        "handling parcel": "处理包裹", "handling package": "处理包裹",
    },
    "entity": {
        "port": "港口", "harbour": "港口", "terminal": "港口",
        "ship": "船舶", "vessel": "船舶", "crane": "吊机",
        "cargo": "货物", "freight": "货物", "goods": "货物",
    },
}
