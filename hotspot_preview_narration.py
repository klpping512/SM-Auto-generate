    ...
    return [
        {
            ...
            "content": (
                ...
                "热点不证明 Buffalo 服务，Buffalo 也不能宣称已解决该热点；不写绝对时效、成本、安全或覆盖率。"
                ...
                "热点画面只说发生了什么，Buffalo 视频只说可见动作。evidence_type=image 是 Buffalo 自有图片，"
    ...
    return [
        {
            ...
            "content": (
                ...
                "(1)热点镜是否只复述给定热点事实；(2)品牌镜是否只描述可见动作与给定 RAG 边界；"
