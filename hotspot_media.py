...
def prefilter_mother_candidate(item: dict) -> tuple[bool, str]:
    ...
    # Do not reject authorised news videos by headline topic. Court, election,
    # sports and studio-labelled items can still contain relevant field footage;
    # the downloaded mother must reach segment vision, visual audit and factual
    # audit before a Hook is accepted. This prefilter is intentionally limited
    # to cheap, deterministic non-news/size failures.
